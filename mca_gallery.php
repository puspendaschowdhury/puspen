      ...
      <li class="active"><a href="#">Tutorial</a>
        <ul>
          ...
          <ul style="left: 150px; top: 0px;">
		  		...
		  		<li class="active"><a href="mca_gallery.php">MCA</a></li>
    ...
    <div id="gallery" class="clear">
      <div class="gallerycontainer clear">
        <div class="fl_left">
		  ...
		  <p>Video 1: C Programming Tutorial: Arrays (One and Two Dimensional Array ).</p>
		  <p>Video 2: Basic program in C programming language.</p>
        </div>
        <div class="fl_right">
          <ul>
            <li><a href="https://www.youtube.com/watch?v=NFJMjgXb0uA" rel="prettyPhoto[gallery1]" title="Video 1"><img src="../images/demo/array.jpg" alt="" /></a></li>
            <li class="last"><a href="https://www.youtube.com/watch?v=MgiTw53so60" rel="prettyPhoto[gallery1]" title="Video 2"><img src="../images/demo/program.jpg" alt="" /></a></li>
          </ul>
        </div>
      </div>
      <!-- ########### -->
      <div class="gallerycontainer clear">
        <div class="fl_left">
		  ...
		  <p>Video 1: Truth Table Tutorial - Discrete Mathematics Logic.</p>
		  <p>Video 2: Set Theory, Venn Diagrams, union, intersection, and complements, Problems : Discrete Mathematics.</p>
        </div>
        <div class="fl_right">
          <ul>
            <li><a href="https://www.youtube.com/watch?v=wRMC-ttjhwM" rel="prettyPhoto[gallery1]" title="Video 1"><img src="../images/demo/truth.jpg" alt="" /></a></li>
            <li class="last"><a href="https://www.youtube.com/watch?v=_7fzGD75RrE" rel="prettyPhoto[gallery1]" title="Video 2"><img src="../images/demo/set.jpg" alt="" /></a></li>
          </ul>
        </div>
      </div>
      <!-- ########### --> 
