...
<head>
<title>VUI University | Gallery</title>
...
<ul>
      ...
      <li class="active"><a href="#">Tutorial</a>
        <ul>
          <li><a href="#">Videos</a>
    ...
    <div id="gallery" class="clear">
      <div class="gallerycontainer clear">
        <div class="fl_left">
		  ...
		  <p>Video 1: It gives the knowledge how do C programming works.</p>
		  <p>Video 2: A renouned professor will teach you Concepts of Algorithm, Flow Chart & C Programming.</p>
        </div>
        <div class="fl_right">
          <ul>
            <li><a href="https://www.youtube.com/watch?v=AWliApDc61w" rel="prettyPhoto[gallery1]" title="Video 1"><img src="../images/demo/c_big.gif" alt="" /></a></li>
            <li class="last"><a href="https://www.youtube.com/watch?v=DF2XAc07eI0" rel="prettyPhoto[gallery1]" title="Video 2"><img src="../images/demo/c_prof.gif" alt="" /></a></li>
          </ul>
        </div>
      </div>
      <!-- ########### -->
      <div class="gallerycontainer clear">
        <div class="fl_left">
		  ...
		  <p>Video 1: Learn how to find Matrix and Dreterminants.</p>
		  <p>Video 2: Learn Set Theory.</p>
        </div>
        <div class="fl_right">
          <ul>
            <li><a href="https://www.youtube.com/watch?v=SJOTtb1FTfs" rel="prettyPhoto[gallery1]" title="Video 1"><img src="../images/demo/m_matrix.gif" alt="" /></a></li>
            <li class="last"><a href="https://www.youtube.com/watch?v=yCwnifwVjIg" rel="prettyPhoto[gallery1]" title="Video 2"><img src="../images/demo/m_set.gif" alt="" /></a></li>
          </ul>
        </div>
      </div>
      <!-- ########### --> 
<div class="gallerycontainer clear">
        <div class="fl_left">
          <h2 class="title">Unix</h2>
		  <p>Video: It gives the knowledge how to use UNIX.</p>
		  </div>
        <div class="fl_right">
          <ul>
            <li><a href="https://www.youtube.com/watch?v=pYUGzgYAgEo" rel="prettyPhoto[gallery1]" title="Video 1"><img src="../images/demo/Unix1.jpg" alt="" /></a></li>
          </ul>
        </div>
      </div>
      <!-- ########### --> 
