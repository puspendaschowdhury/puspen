...
<title>VUI University | Result</title>
</head>
...
include('connect.php');
 $query = mysql_query("SELECT * FROM `result` ");
	 ...
	 ?>
     <form name="a" action="a.php" method="post">
 <table width="314" height="148" border="1" align="center">
    <tr>
    ...
    <tr>
      <td width="51"><strong>Marks</strong></td>
      <td width="133"><?php echo $row["marks"]  ?></td>
    </tr>
    <tr>
