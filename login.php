...
<head>
<title>VUI University | Login</title>
...
<!-- ####################################################################################################### -->
 <div class="wrapper row4">
  	<strong><font size="+3"><div align="center">STUDENT LOGIN</div></font> </strong>
	<form id="form2" name="form2" method="post" action="paper.php">
			
		      <table width="68%" height="45" align="center" bgcolor="#A5DBDE">
       
        <tr>
          <td width="48%"><font size="+1">
            <div align="right" class="style6">E-mail ID </div></font>            
          </td>
          <td width="52%"><label>
        ...
        <tr>
          ...
          <td><label>
            <input name="psd" type="password" id="psd" />
          </label></td>
        </tr>
        <tr>
