    ...
    <div id="gallery" class="clear">
      <div class="gallerycontainer clear">
        <div class="fl_left">
		  ...
		  <p>Video 1: Posting Ledger [LEDGER from JOURNAL], Simple method with solved problem :- Accounting tutorial.</p>
		  <p>Video 2: Introduction to Cost Accounting - (COST SHEET).</p>
        </div>
        <div class="fl_right">
          <ul>
            <li><a href="https://www.youtube.com/watch?v=LvCvAVPBBnU" rel="prettyPhoto[gallery1]" title="Video 1"><img src="../images/demo/ledger.jpg" alt="" /></a></li>
            <li class="last"><a href="https://www.youtube.com/watch?v=FlisUOIwOnw" rel="prettyPhoto[gallery1]" title="Video 2"><img src="../images/demo/cost.jpg" alt="" /></a></li>
          </ul>
        </div>
      </div>
      <!-- ########### -->
      <div class="gallerycontainer clear">
        <div class="fl_left">
		  ...
		  <p>Video 1: Business Math - Finance Math .</p>
		  <p>Video 2: BBA Quantitative method Question Paper.</p>
        </div>
        <div class="fl_right">
          <ul>
            <li><a href="https://www.youtube.com/watch?v=qO1SYFZVmhY" rel="prettyPhoto[gallery1]" title="Video 1"><img src="../images/demo/si.jpg" alt="" /></a></li>
            <li class="last"><a href="https://www.youtube.com/watch?v=SKXtRSc-Ons" rel="prettyPhoto[gallery1]" title="Video 2"><img src="../images/demo/bba.jpg" alt="" /></a></li>
          </ul>
        </div>
      </div>
      <!-- ########### --> 
